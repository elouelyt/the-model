...
| **Sprint 6** | Data Enrichment & Model Upgrade | ✅ 1. Surface/conditions feature (clay/grass/hard/indoor badge + recommendation context). ✅ 2. H2H data (Sackmann dataset, 4 yrs, per-surface). ✅ 3. News/sentiment agent (Google News RSS, keyword scoring, parallel fetch). 4. Upgrade ranking model to logistic regression. 5. Add `docs/ML_ENGINEER.md` agent persona. | Enriched predictions, trained baseline model — improvements go live immediately | 12–15 hrs | Apr 2026 | 🔄 In Progress |
